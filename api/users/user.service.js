...
if (body.type=="0"){
     pool.query(
        ...
        [
        body.name,body.mobileno,body.whatsappno,body.email,body.time,body.address,body.location,body.description,locid,body.username,body.password,imageUrl+req.file.filename,isactive
        ],
...
return callback(null,results[0])
       ...
       pool.query(
        ...
        [
        body.name,body.mobileno,body.whatsappno,body.email,body.time,body.address,body.location,body.description,locid,body.password,imageUrl+req.file.filename,body.username,
        ],
  ...
  const locid=parseInt(body.nearestlocationid);
    const catid=parseInt(body.designationid);
     ...
     pool.query(
        ...
        [
        body.name,body.mobileno,body.whatsappno,catid, body.address,body.location,body.description,locid,body.username,body.password,imageUrl+req.file.filename,isvisible,isactive,hospitalid,body.email
        ],
...
return callback(null,results[0])
 ...
 pool.query(
        ...
        [
        body.name,body.mobileno,body.whatsappno,catid, body.address,body.location,body.description,locid,body.password,imageUrl+req.file.filename,isvisible,isactive,hospitalid,body.email,body.username
        ],
...
//    return callback(null,results1,results2[0]["name"],results2[0]["email"])
 ...
 if(body.type=="2"){
       ...
       pool.query(
        ...
        [
        body.email,body.name,locid,imageUrl+req.file.filename,body.mobileno,
        ],
